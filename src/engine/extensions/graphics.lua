...
-- Alternative to newFont
function love.graphics.makeFont(src, size, line_height)
...
function love.graphics.ring(x, y, r, thickness, inside_color, border_color)
   ...
   love.graphics.setColor(inside_color)
   love.graphics.circle("fill", x, y, r - thickness)
end
